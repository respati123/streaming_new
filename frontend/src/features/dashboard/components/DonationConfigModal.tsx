...
export function DonationConfigModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-xs font-sans text-[#18181B]">
      <div className="relative w-full max-w-[460px] rounded-2xl bg-[#FFFFFF] border border-[#D4D4D8] shadow-2xl overflow-hidden flex flex-col">
        <div className="px-5 py-4 border-b border-[#D4D4D8] bg-[#F4F4F5] flex items-center justify-between">
        ...
        <div className="p-5 space-y-5 overflow-y-auto max-h-[80vh]">
          ...
          <div className="space-y-2.5">
            <div className="text-[11px] font-bold uppercase tracking-wider text-[#52525B] flex items-center gap-1.5">
              ...
              <button
                ...
                className={`w-full text-left p-3 rounded-xl border transition-all flex items-center justify-between ${
                  draftTemplate === 'cat-jam'
                    ? 'bg-zinc-950/20 border-zinc-400/60 shadow-lg shadow-zinc-950/30'
                    : 'bg-[#F4F4F5] border-[#D4D4D8] hover:border-zinc-700'
                }`}
              >
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-lg bg-zinc-500/10 text-zinc-400 border border-zinc-500/30">
                ...
                {draftTemplate === 'cat-jam' && (
                  <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-zinc-950/80 text-zinc-300 border border-zinc-500/40">
                    Aktif
                  </span>
                )}
              </button>
          ...
          <div className="space-y-2.5">
            <div className="text-[11px] font-bold uppercase tracking-wider text-[#52525B]">
              2. AUDIO CHIME & EFEK SUARA
            </div>

            <div className="p-3.5 rounded-xl bg-[#F4F4F5] border border-[#D4D4D8] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={onTestSound}
                  className="px-2.5 py-1 rounded-lg bg-zinc-600 hover:bg-zinc-500 text-white text-xs font-bold flex items-center gap-1.5 transition-colors"
                >
        ...
        <div className="px-5 py-3.5 border-t border-[#D4D4D8] bg-[#F4F4F5] flex items-center justify-end gap-2.5">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-xl bg-[#E4E4E7] hover:bg-[#D4D4D8] border border-[#D4D4D8] text-xs font-bold text-[#52525B] hover:text-white transition-colors"
          >
            Batal
          </button>
          <button
