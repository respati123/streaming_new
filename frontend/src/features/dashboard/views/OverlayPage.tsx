              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1.5 mb-0.5">
                  <div className="flex items-center gap-1.5 flex-wrap min-w-0">
                    ...
                    {msg.isModerator && (
                      <span className="px-1.5 py-0.2 rounded text-[9px] font-black bg-blue-500/30 text-blue-300 border border-blue-500/50 font-mono flex items-center gap-0.5 shadow-xs">
                        <RiShieldCheckFill className="text-[10px]" /> MOD
                      </span>
                    )}
                    {msg.isSponsor && (
                      <span className="px-1.5 py-0.2 rounded text-[9px] font-black bg-emerald-500/30 text-emerald-300 border border-emerald-500/50 font-mono flex items-center gap-0.5 shadow-xs">
                        <RiStarFill className="text-[10px]" /> MEMBER
                      </span>
                    )}
                    {msg.tier && msg.tier !== 'bronze' && !msg.isOwner && (
                      <span
                        className={`px-1.5 py-0.2 rounded text-[9px] font-black uppercase font-mono flex items-center gap-0.5 shadow-xs ${
                          msg.tier === 'diamond'
                            ? 'bg-cyan-500/35 text-cyan-200 border border-cyan-400/70 shadow-[0_0_8px_rgba(0,212,255,0.4)]'
                            : msg.tier === 'gold'
                              ? 'bg-amber-500/35 text-amber-200 border border-amber-400/70'
                              : 'bg-zinc-400/35 text-zinc-200 border border-zinc-400/70'
                        }`}
                      >
                    ...
                    {msg.isVerified && !msg.isOwner && (
                      <span className="px-1.5 py-0.2 rounded text-[9px] font-black bg-cyan-500/30 text-cyan-300 border border-cyan-500/50 font-mono flex items-center gap-0.5 shadow-xs">
                  ...
                  <span className="text-[10px] font-mono font-medium text-zinc-300/80 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] shrink-0">
      ...
      {(widgetFilter === 'all' || widgetFilter === 'webcam') && showWebcamFrame && (
        <div className="absolute right-3 bottom-3 w-[280px] h-[190px] border-2 border-white/20 bg-transparent rounded-2xl overflow-hidden shadow-2xl flex flex-col justify-between p-2.5 pointer-events-none">
          <div className="flex items-center justify-between text-white">
            ...
            <span className="text-[9px] font-mono text-zinc-300 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
              1080p 60fps
            </span>
          </div>
